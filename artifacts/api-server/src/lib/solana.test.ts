...
describe("isValidSolanaAddress", () => {
  it("accepts valid base58 Solana addresses", () => {
    expect(
      isValidSolanaAddress("4EtAJ1p8RjqccEVhEhaYnEgQ6kA4JHR8oYqyLFwARUj6"),
    ).toBe(true);
  ...
  it("rejects invalid base58 characters", () => {
    expect(
      isValidSolanaAddress("4EtAJ1p8RjqccEVhEhaYnEgQ6kA4JHR8oYqyLFwARUj0"),
    ).toBe(false); // 0/O confusion
  ...
  it("rejects wrong length", () => {
    ...
    expect(
      isValidSolanaAddress("4EtAJ1p8RjqccEVhEhaYnEgQ6kA4JHR8oYqyLFwARUj"),
    ).toBe(false);
  });
