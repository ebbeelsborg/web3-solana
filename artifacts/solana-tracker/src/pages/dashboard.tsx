      ...
      { data: { address: address.trim() } },
      {
        ...
        onError: (error: any) => {
          ...
          toast({
            ...
            description:
              error?.data?.error || "Could not track this wallet address.",
          });
        },
      },
    );
      ...
      >
        <div className="space-y-4">
          ...
          <p className="text-lg text-muted-foreground max-w-lg mx-auto">
            Monitor incoming and outgoing transactions instantly. No page
            refreshes. Pure WebSockets.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: "Transactions pushed instantly via WebSockets",
            },
            {
              icon: Shield,
              title: "No Authentication",
              desc: "Track public ledgers anonymously",
            },
            {
              icon: Zap,
              title: "Blazing Fast",
              desc: "Built on direct RPC node polling",
            },
          ].map((feature, i) => (
            <motion.div
              key={i}
